...
class DataEnrich:
    ...
    def _load_raw_pickle(self):
        return pickle.load(open('/home/jordi/Desktop/UNI/TFG/LSTM/raw_labeled.pkl',"rb"))
    ...
    def get_enriched_data(self, from_pickle):
        if from_pickle:
            if os.path.isfile('/home/jordi/Desktop/UNI/TFG/LSTM/raw_enriched.pkl'):
                print("Reading raw_enriched.pkl")
                return pickle.load(open('/home/jordi/Desktop/UNI/TFG/LSTM/raw_enriched.pkl', "rb"))
            else:
        ...
        print("Done, dumping")
        pickle.dump(traj, open('/home/jordi/Desktop/UNI/TFG/LSTM/raw_enriched.pkl', "wb"))
        return traj
