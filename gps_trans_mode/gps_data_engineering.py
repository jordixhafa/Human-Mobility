...
class GpsDataEngineering(object):
    ...
    def calculate_distance(self, pointA, pointB):
        ...
        if (pointB[0] > 90): pointB = (pointB[0]/10, pointB[1])
        if (pointA[0] > 90): pointA = (pointA[0]/10, pointA[1])
    ...
    def add_timestamp(self):
        ...
        self.df_gps[TIMESTAMP_STR] = list(map(self.dt_to_timestamp, td))
    ...
    def calculate_segment_characteristics(self, segment_file_path):
        ...
        for seg_id in segment_ids:
            ...
            for i, row in pd_segment.iterrows():
                ...
                #print(np.array(list(prev_time)).shape)
                #print(np.array(list(row[TIMESTAMP_STR])).shape)
...
if __name__ == "__main__":
    gpsde = GpsDataEngineering("/home/jordi/Desktop/UNI/TFG/DT-RF-LR-SVM-KNN/gps_points_master.csv")
    gpsde.add_timestamp()          # Add timestamp entry for each GPS point
    gpsde.calculate_segment_characteristics('/home/jordi/Desktop/UNI/TFG/DT-RF-LR-SVM-KNN/segment_master.csv')
