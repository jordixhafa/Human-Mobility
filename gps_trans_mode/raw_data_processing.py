...
if __name__ == "__main__":
    ...
    lp.find_labels('/home/jordi/Desktop/UNI/TFG/projecte/Data/')               # Find labels
    lp.process_time_label()                 # Process labels
    lp.save_to_csv("/home/jordi/Desktop/UNI/TFG/DT-RF-LR-SVM-KNN/labels_master.csv")     # Save to CSV

    lp.search_trajectory_data("/home/jordi/Desktop/UNI/TFG/DT-RF-LR-SVM-KNN/file_structure_master.csv")     # Search and save file structure for GPS data
    # lp.label_df = pd.read_csv("labels_master.csv")
    lp.create_gps_points_master("/home/jordi/Desktop/UNI/TFG/DT-RF-LR-SVM-KNN/gps_points_master.csv", "/home/jordi/Desktop/UNI/TFG/DT-RF-LR-SVM-KNN/file_structure_master.csv")