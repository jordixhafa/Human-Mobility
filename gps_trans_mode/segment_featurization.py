...
if __name__ == "__main__":
    sf = SegmentFeaturization("/home/jordi/Desktop/UNI/TFG/DT-RF-LR-SVM-KNN/segment_master.csv")
    sf.featurize_segment()
    sf.save_to_csv("/home/jordi/Desktop/UNI/TFG/DT-RF-LR-SVM-KNN/segment_featured_master.csv")
