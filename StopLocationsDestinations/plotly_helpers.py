...
def plot_datasample(df_plotting):
    ...
    fig = go.Figure(data = [go.Scattermapbox(lat=df_plotting["latitude"],
                                            ...
                                            marker=go.scattermapbox.Marker(size=3,opacity = 0.3))
                            ],
...
def plot_one_user(df_plotting):
    ...
    fig = go.Figure(data = [go.Scattermapbox(lat=df_plotting["latitude"],
                                            ...
                                            textposition='bottom center',
                                            marker=go.scattermapbox.Marker(size=14,opacity = 0.7))
                            ],
                    layout = go.Layout(autosize=False,
                                       width=640,
                                       height=300,
...
def plot_stops(df_plotting):
    fig = go.Figure(data = [go.Scattermapbox(lat=df_plotting["latitude"],
                                            ...
                                            text="User ID: " + df_plotting["user_id"].apply(str),
                                            textposition='bottom center',
                                            marker=go.scattermapbox.Marker(size=5,opacity = 1, color='orange'))
                            ],
                    layout = go.Layout(autosize=False,
                                    width=640,
                                    height=300,
...
def plot_destinations(df_plotting):
    ...
    fig = go.Figure(data = [go.Scattermapbox(lat=df_plotting["latitude"],
                                            ...
                                            textposition='bottom center',
                                            marker=go.scattermapbox.Marker(size=sizes,
                                                            opacity = 1, 
